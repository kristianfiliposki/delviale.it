...
@section('content')
    <head>
        ...
        <link rel="stylesheet" href="gelati.css">
                        ...
                        <div class="row"><h1 class="col-12 mb-32 mr-32">Anni di studio per un buon gelato</h1></div>
                            ...
                            <div class=" w-100 vh-50  mb-64">
                                <div class="w-100 h-100  ">
                                    <img src="/public/img/prep-4.jpeg" alt="foto" class="w-100 h-100 presentazione">
                                </div>
                            </div>
                            <!--Carosello-->
            
                            <!-- gelati jambotron -->
                            <div class="row"><h1 class="col-12 mb-32 mr-32">I nostri gelati sono il nostro vanto!</h1></div>
                            ...
                            <div class=" w-100 vh-50 ">
                                <div class="w-100 h-100 d-flex ">
                                        ...
                                        <div class=" d-flex  h-100 box" >
                                            <div class="w-50 h-50  mini-box"><img src="/public/img/Coppetta-fragola.jpeg" alt="foto" class="w-100 h-100 "></div>
                                            <div class="w-50 h-50 mini-box"><img src="/public/img/Coppetta-frutta.jpeg" alt="foto" class="w-100 h-100"></div>
                                            <div class="w-50 h-50 mini-box"><img src="/public/img/Coppetta-limone.jpeg" alt="foto" class="w-100 h-100"></div>
                                            <div class="w-50 h-50  mini-box"><img src="/public/img/Coppetta-mandorla.jpeg" alt="foto" class="w-100 h-100"></div>
                                        </div>
                                        
                                        <div class=" box central" >
                                            <div class=" h-100 first"></div>
                                            <div class=" h-100 second"></div>
                                        </div>
                    
                                        <div class=" d-flex  h-100 box"  >
                                            <div class="w-50 h-50 mini-box"><img src="/public/img/Coppetta-mango.jpeg" alt="" class="w-100 h-100"></div>
                                            <div class="w-50 h-50  mini-box"><img src="/public/img/Coppetta-panna.jpeg" alt="" class="w-100 h-100"></div>
                                            <div class="w-50 h-50  mini-box"><img src="/public/img/Coppetta-pistacchio.jpeg" alt="" class="w-100 h-100"></div>
                            ...
                            <div class="row partner container-fluid w-100 d-flex justify-content-center align-content-around">
                                ...
                                <div class="box h-30 col-10 bg-white f-24 account-plus">
                                ...
                                <div class="box h-30 col-10 bg-white ">
                                ...
                                <div class="box h-30 col-10 bg-white f-24">
                                    <div class="col-12 ">
